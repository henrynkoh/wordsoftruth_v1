# -*- encoding: utf-8 -*-
# stub: attr_encrypted 4.2.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Sean Huber".freeze, "S. Brent Faulkner".freeze, "William Monk".freeze, "Stephen Aghaulor".freeze, "Josh Branham".freeze, "Mike Vastola".freeze]
  s.date = "2025-01-23"
  s.description = "Generates attr_accessors that encrypt and decrypt attributes transparently".freeze
  s.email = ["seah@shuber.io".freeze, "sbfaulkner@gmail.com".freeze, "billy.monk@gmail.com".freeze, "saghaulor@gmail.com".freeze, "josh.php@gmail.com".freeze, "Mike@Vasto.la".freeze]
  ...
  s.add_development_dependency(%q<activerecord>.freeze, [">= 6.0.0"])
